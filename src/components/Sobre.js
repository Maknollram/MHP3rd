    ...
    template: `
        <div>
            <section class="container coluna center">
                ...
                <label class="fonte30 nomeMonstro">Sobre</label>
            </section>
            <br>
            <div>
                <div class="container coluna center">
                    <div> 
                        <img class="logoSobre" src="./src/imgs/mhp3rd.png">
                    </div>
                    <br>
                    <br>
                    <label class="fonte18 nomeMonstro">Guia MHP 3rd</label>
                    <br>
                    <label>Desenvolvido por: Maknollram</label>
                    <br>
                    <label>Em: 2019</label>
                    <br>
                    <label>Versão: 1.1.8</label>
                    </div>
            </div>
        </div>
    `,
